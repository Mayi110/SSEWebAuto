...
class regularPage(object):
    ...
    def __init__(self,driver):
        ...
        self.regularOptions = self.parseCF.getItemsSection('regularPage')
    ...
    def announcementLinkObj(self):
        try:
            locateType,locatorExpression = self.regularOptions['regularPage.announcementLink'.lower()].split('>')
            elementObj = getElement(locateType,locatorExpression)
            return elementObj
        except Exception as e:
            raise e
